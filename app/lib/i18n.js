...
export const translations = {
  ko: {
    ...
    statsTab: '통계',
    timetableTab: '시간표',
    timetableComingSoon: '시간표는 곧 공개 예정이에요. (Premium 기능)',
    settings: '설정',
    ...
    prefDayStart: '하루 시작',
    prefDayEnd: '하루 끝',
    prefDayWindowHint: '홈 시간표에서 보이는 시간대예요. 시 단위로만 지정해요. 종료가 시작보다 이르면 다음 날까지 이어져요.',
    ...
    timetableSyncFromNotionAria: '노션에서 시간표 불러오기',
    timetableSyncToNotionAria: '노션으로 시간표 보내기',
  ...
  en: {
    ...
    timetableComingSoon: 'The timetable will be available soon. (Premium feature)',
    settings: 'Settings',
    ...
    prefDayEnd: 'Day ends',
    prefDayWindowHint: 'Used on the home timetable. Hours only (no minutes). If end is before start on the clock, hours continue past midnight.',
    ...
    timetableSyncFromNotionAria: 'Pull timetable from Notion',
    timetableSyncToNotionAria: 'Push timetable to Notion',
