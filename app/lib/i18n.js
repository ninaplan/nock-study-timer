...
export const translations = {
  ko: {
    ...
    supportHelp: '도움 · 문의',
    supportSendMail: '오류·문의 메일 보내기',
    supportSendMailHint: '메일 앱이 열리며 앱 버전·기기·시간대 등이 함께 붙습니다.',
    supportFeedback: '피드백·기능 제안',
    supportFeedbackHint: 'UserJot 보드에서 제안·투표 (브라우저로 열림)',
    legalSection: '약관 · 정책',
    newsUpdates: '새 소식',
  ...
  en: {
    ...
    supportSendMail: 'Send issue / feedback email',
    supportSendMailHint: 'Opens your mail app with app version, device, locale, and time zone.',
    supportFeedback: 'Feedback & ideas',
    supportFeedbackHint: 'Suggest and vote on UserJot (opens in browser)',
    legalSection: 'Legal & policy',
