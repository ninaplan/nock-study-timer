...
export const viewport = {
  ...
  maximumScale: 1,
  userScalable: false,
  /** iOS PWA / 노치: 없으면 env(safe-area-inset-*)가 0으로 떨어져 스크림·배경 띠가 생김 */
  viewportFit: 'cover',
      ...
      <head>
        ...
        <style
          dangerouslySetInnerHTML={{
            __html: `html,body{margin:0}html{height:100%;height:100dvh;min-height:100%;min-height:100dvh;min-height:-webkit-fill-available;background:#F2F2F7}body{height:100%;height:100dvh;min-height:100%;min-height:100dvh;min-height:-webkit-fill-available;background:#F2F2F7;color:#000}@media (prefers-color-scheme:dark){html,body{background:#000;color:rgba(235,235,245,.92)}}@keyframes _appBootSpin{to{transform:rotate(360deg)}}`,
          }}
        />
