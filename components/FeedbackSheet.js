    ...
    <>
      ...
      <div className="sheet">
        ...
        <div className="sheet-body" style={{ paddingBottom: 'max(24px, env(safe-area-inset-bottom))' }}>
          {isDemoMode && (
            <div style={{ background:'rgba(255,149,0,0.1)', border:'1px solid var(--orange)', borderRadius:12, padding:'10px 14px', fontSize:13, color:'var(--orange)', marginBottom:14, fontWeight:600 }}>
              {t.connectToSave}
            </div>
          )}
