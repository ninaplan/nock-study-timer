...
/**
 * 홈 상단 날짜 라벨 anchor 바로 아래에 붙는 월 그리드.
 * @param {object} props
 ...
 * @param {string} [props.dismissLabel] — 배경 닫기 버튼 aria-label
...
export default function HomeTopDatePopover({
  ...
  return (
    <NockPopover
      ...
      dismissAriaLabel={dismissLabel || (ko ? '닫기' : 'Close')}
      ariaLabel={ariaLabel || (ko ? '날짜 선택' : 'Choose date')}
      panelClassName="home-top-date-popover"
    >
